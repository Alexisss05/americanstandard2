    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative flex items-center overflow-hidden min-h-[680px] md:min-h-screen">
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24 pb-8 text-center">
          ...
          <p className="text-muted-foreground text-2xl md:text-2xl font-heading font-semibold max-w-3xl mx-auto mb-8">
            Todo lo que necesitas para aprender un nuevo idioma,<br></br>en un
            solo lugar
          </p>
          <a
      ...
      <section className="relative py-16">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <h1 className="text-2xl md:text-3xl font-heading font-bold text-center text-foreground mb-8 animate-on-scroll">
          ...
          <div className="grid md:grid-cols-3 gap-6 stagger-children">
            ...
            {valores.map((v) => (
              <div
                key={v.title}
                className="animate-on-scroll bg-card/80 backdrop-blur-sm rounded-xl p-6 border border-border card-hover text-center"
              >
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <Button
                variant="hero"
                size="lg"
                className="text-base px-10 py-6 mt-4 animate-on-scroll"
              >
